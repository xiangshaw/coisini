package cn.coisini.system.config;
...
import cn.coisini.system.security.MyUserDetailsServiceImpl;
import cn.coisini.system.security.TokenAuthenticationFilter;
import cn.coisini.system.security.TokenLoginFilter;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .antMatchers(HttpMethod.GET, // 允许对于网站静态资源的无授权访问
                        ...
                        "/v2/api-docs/**")
                .permitAll()
                .antMatchers("/system/index/login", "/system/index/code", "/system/index/register")// 对登录、注册、验证码 允许匿名访问
                .permitAll()
